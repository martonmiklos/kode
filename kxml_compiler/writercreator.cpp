...
void WriterCreator::createElementWriter(KODE::Class &c, const Schema::Element &element)
{
...
// and creator
QString WriterCreator::dataToStringConverter(const QString &data, Schema::Node::Type type)
{
    QString converter;
